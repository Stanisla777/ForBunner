...
exports.build = gulp.series(clear,less_for_build,html,js,jsCopy,img,delSvgIconSrc,delSvgIconDist,createSprite,convertFont)

// продакшен с минимизацией html и css, и объединением css файлов в один
exports.production = gulp.series(clear,allcss,html_for_prod,js_prod,jsCopy,img,delSvgIconSrc,delSvgIconDist,createSprite,convertFont,replacehtml)

//продакшен, в котором фоайлы less из папки partcss по отдельности вставляются в продакшен
exports.prodseparatecss = gulp.series(clear,separatecss,html,js,jsCopy,img,delSvgIconSrc,delSvgIconDist,createSprite,convertFont)


//разработка
exports.serve = gulp.series(less,html,js,jsCopy,img,delSvgIconSrc,delSvgIconDist,createSprite,convertFont,serve)
